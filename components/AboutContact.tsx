...
import { FOUNDER_INFO, WHATSAPP_URL, WHATSAPP_NUMBER } from '../constants';
    ...
    <section className="bg-slate-50 py-20 border-t border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16" id="about">
          ...
          {/* Contact Section */}
          <div id="contact" className="bg-slate-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden transform transition-all duration-500 hover:scale-[1.01] hover:shadow-2xl">
             {/* Decorative circles */}
