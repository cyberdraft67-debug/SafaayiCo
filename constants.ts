...
export const PRODUCTS: Product[] = [
  {
    ...
    options: [
      { label: 'Single Box (150 pulls)', price: 180 },
      { label: 'Family Pack (3 Boxes)', price: 500 },
      { label: 'Carton (12 Boxes)', price: 1900 }
    ]
  },
  {
    id: 'p2',
    ...
    options: [
      { label: 'Small (Roll of 30)', price: 350 },
      { label: 'Large (Roll of 20)', price: 350 },
      { label: 'Extra Large (Roll of 15)', price: 400 }
    ]
  },
  {
    id: 'p3',
    ...
    options: [
      { label: 'Small - Snack Size (25 bags)', price: 250 },
      { label: 'Medium - Sandwich Size (20 bags)', price: 300 },
      { label: 'Large - Gallon Size (15 bags)', price: 350 }
    ]
  },
  {
    id: 'p4',
    ...
    options: [
      { label: 'Standard Roll (10 meters)', price: 450 },
      { label: 'Mega Roll (25 meters)', price: 950 },
      { label: 'Catering Pack (75 meters)', price: 2200 }
    ]
  },
  {
    id: 'p5',
    ...
    options: [
      { label: 'Home Roll (30 meters)', price: 300 },
      { label: 'Chef Roll (100 meters)', price: 850 },
      { label: 'Commercial Roll (300 meters)', price: 2100 }
    ]
  },
  {
    id: 'p6',
    ...
    options: [
      { label: 'Pack of 4 Rolls', price: 480 },
      { label: 'Pack of 12 Rolls', price: 1350 },
      { label: 'Family Bundle (24 Rolls)', price: 2600 }
    ]
  },
  {
    id: 'p7',
    ...
    options: [
      { label: 'Pack of 50 (Small 6oz)', price: 350 },
      { label: 'Pack of 50 (Large 8oz)', price: 450 },
      { label: 'Office Pack (100 Large)', price: 850 }
    ]
  }
];
